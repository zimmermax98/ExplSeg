...
def log_tensorboard(writer, epoch, train_info, eval_info):
    writer.add_scalar('Val mIoU', eval_info["Mean IoU"], epoch)
    writer.add_scalar('Val Acc', eval_info["Overall Acc"], epoch)
    writer.add_scalar('Train mIoU', train_info["Mean IoU"], epoch)
    writer.add_scalar('Train Acc', train_info["Overall Acc"], epoch)